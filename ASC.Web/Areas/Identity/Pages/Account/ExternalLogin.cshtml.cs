    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Thông tin tài khoản không hợp lệ: thiếu trạng thái IsActive.");
                    return Page();
                }

                bool isActive = bool.TryParse(isActiveClaim.Value, out var result1) && result1;
